...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        <!-- <a class="navbar-brand brand-log me-5" href="<?php echo htmlspecialchars($baseUrl . 'admin/dashboard'); ?>"><img src="<?php echo htmlspecialchars($assetsUrl); ?>images/log.svg" class="me-2" alt="logo" /></a>
        <a class="navbar-brand brand-log-mini" href="<?php echo htmlspecialchars($baseUrl . 'admin/dashboard'); ?>"><img src="<?php echo htmlspecialchars($assetsUrl); ?>images/log-mini.svg" alt="logo" /></a> -->
    </div>
